   ...
   private ProductJpa prepo;
    ...
    repo.saveAll(List.of(m1, m2, m3, m4, m5, m6, m7, m8));
     ...
     Product p3 = new Product(3,"iphone",17000,Arrays.asList(m4,m2,m8));
      ...
      List<Object[]> obj1 = prepo.fetchAllProductsLeftJoins();
      for(Object[] o :obj1) {
    	  System.out.println(o[0]+"------>"+o[1]);
      }
      List<Object[]> obj2 = prepo.fetchAllProductsRightJoins();
      for(Object[] o :obj2) {
    	  System.out.println(o[0]+"------>"+o[1]);
      }
      List<Object[]> obj3 = prepo.fetchAllProductsINNERJoins();
      for(Object[] o :obj3) {
    	  System.out.println(o[0]+"------>"+o[1]);
      }
      List<Object[]> obj4 = prepo.fetchAllProductsRightOuterJoins();
      for(Object[] o :obj4) {
    	  System.out.println(o[0]+"------>"+o[1]);
      }
      List<Object[]> obj5 = prepo.fetchAllProductsLefttOuterJoins();
      for(Object[] o :obj5) {
    	  System.out.println(o[0]+"------>"+o[1]);
      }
	}
